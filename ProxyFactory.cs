...
namespace DynamicProxy
{
	public class ProxyFactory
	{
        ...
        private static readonly IDictionary<Type,OpCode> opCodeTypeMapper = new Dictionary<Type,OpCode>();
        ...
        private readonly static ProxyFactory instance = new ProxyFactory();
